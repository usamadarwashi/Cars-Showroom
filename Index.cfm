...
<body onLoad="lastmod()">
	...
	<section class="Ranges">
		<h1>Our Ranges of cars</h1>
		<p>Here in Phoenix Cars showroom, we offer a variety of ranges of cars</p>
		<div class="row">
			<cfoutput query="rng">
			<div class="range-col">
				<a href="Range.cfm?theModel=#rng.Range_ID#" title="Go to #Range_Title#">
				<img src="#Range_URL#">
				<div class="layer">
					<h3>#Range_Title#</h3>
					<p>#Range_Info#</p>
