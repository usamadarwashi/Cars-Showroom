...
<title>Phoenix Cars/Ranges</title>
...
<body onLoad="lastmod()">
	<section class="header" id="mainpage">
		...
		<div class="text-box">
			<cfoutput query="title">
				<h1>#Range_Title# CARS</h1>
				<p>#Range_Info#</p>
			</cfoutput>
			<cfoutput query="link">
			<a href="Model.cfm?theModel=#link.Model_ID#" class="main-btn" title="Go to #Model_Title#">#Model_Title#</a>
			</cfoutput>
	...
	<section class="Ranges">
		<cfoutput query="title">
			<h1>Our Models of #Range_Title# cars</h1>
			<p>Here in Phoenix Cars showroom, we offer a variety of models of #Range_Title# cars</p>
		</cfoutput>
		<div class="row">
			<cfoutput query="link">
			<div class="range-col">
				<a href="Model.cfm?theModel=#link.Model_ID#" title="Go to #Model_Title#">
				<img src="#Refrence#">
				<div class="layer">
					<h3>#Model_Title#</h3>
					<p>#General_Info#</p>
